...
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN K14} [get_ports {DAC_Mode[0]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN G20} [get_ports {DAC_Mode[1]}]



#Keyboard Ribbon Connector
#Drive
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN F20} [get_ports {KeyRibbonDrive[0]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN F19} [get_ports {KeyRibbonDrive[1]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN H17} [get_ports {KeyRibbonDrive[2]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN H16} [get_ports {KeyRibbonDrive[3]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN L17} [get_ports {KeyRibbonDrive[4]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN L16} [get_ports {KeyRibbonDrive[5]}]
...
#Sense
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN M20} [get_ports {KeyRibbonSense[0]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN M19} [get_ports {KeyRibbonSense[1]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN E19} [get_ports {KeyRibbonSense[2]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN E18} [get_ports {KeyRibbonSense[3]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN D18} [get_ports {KeyRibbonSense[4]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN E17} [get_ports {KeyRibbonSense[5]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN B20} [get_ports {KeyRibbonSense[6]}]
set_property -dict {IOSTANDARD LVCMOS33   PACKAGE_PIN C20} [get_ports {KeyRibbonSense[7]}]
