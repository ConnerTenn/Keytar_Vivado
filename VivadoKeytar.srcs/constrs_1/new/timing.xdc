...
# create_generated_clock -name CLK10MHz -source [get_pins system_i/Synth/Clock100MHz] -divide_by 2 -add -master_clock CLK100MHz [get_pins system_i/Synth/inst/clock50MHz]
