...
architecture STRUCTURE of system_RGBTest_0_0_RGBTest is
  ...
  signal clockdiv : STD_LOGIC_VECTOR ( 32 downto 0 );
  signal \clockdiv0_carry__0_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__0_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__0_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__0_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__1_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__1_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__1_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__1_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__2_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__2_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__2_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__2_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__3_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__3_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__3_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__3_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__4_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__4_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__4_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__4_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__5_n_0\ : STD_LOGIC;
  signal \clockdiv0_carry__5_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__5_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__5_n_3\ : STD_LOGIC;
  signal \clockdiv0_carry__6_n_1\ : STD_LOGIC;
  signal \clockdiv0_carry__6_n_2\ : STD_LOGIC;
  signal \clockdiv0_carry__6_n_3\ : STD_LOGIC;
  signal clockdiv0_carry_n_0 : STD_LOGIC;
  signal clockdiv0_carry_n_1 : STD_LOGIC;
  signal clockdiv0_carry_n_2 : STD_LOGIC;
  signal clockdiv0_carry_n_3 : STD_LOGIC;
  signal \clockdiv[32]_i_1_n_0\ : STD_LOGIC;
  signal clockdiv_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal data0 : STD_LOGIC_VECTOR ( 32 downto 1 );
  signal \NLW_clockdiv0_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_RGB[2]_i_7\ : label is "soft_lutpair0";
  ...
  attribute ADDER_THRESHOLD of clockdiv0_carry : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__1\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__2\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__3\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__4\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__5\ : label is 35;
  attribute ADDER_THRESHOLD of \clockdiv0_carry__6\ : label is 35;
...
\FSM_onehot_RGB[2]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FDFFFFFF"
    )
        port map (
...
clockdiv0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => clockdiv0_carry_n_0,
      CO(2) => clockdiv0_carry_n_1,
      CO(1) => clockdiv0_carry_n_2,
      CO(0) => clockdiv0_carry_n_3,
      CYINIT => clockdiv(0),
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(4 downto 1),
      S(3 downto 0) => clockdiv(4 downto 1)
    );
\clockdiv0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => clockdiv0_carry_n_0,
      CO(3) => \clockdiv0_carry__0_n_0\,
      CO(2) => \clockdiv0_carry__0_n_1\,
      CO(1) => \clockdiv0_carry__0_n_2\,
      CO(0) => \clockdiv0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(8 downto 5),
      S(3 downto 0) => clockdiv(8 downto 5)
    );
\clockdiv0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__0_n_0\,
      CO(3) => \clockdiv0_carry__1_n_0\,
      CO(2) => \clockdiv0_carry__1_n_1\,
      CO(1) => \clockdiv0_carry__1_n_2\,
      CO(0) => \clockdiv0_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(12 downto 9),
      S(3 downto 0) => clockdiv(12 downto 9)
    );
\clockdiv0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__1_n_0\,
      CO(3) => \clockdiv0_carry__2_n_0\,
      CO(2) => \clockdiv0_carry__2_n_1\,
      CO(1) => \clockdiv0_carry__2_n_2\,
      CO(0) => \clockdiv0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(16 downto 13),
      S(3 downto 0) => clockdiv(16 downto 13)
    );
\clockdiv0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__2_n_0\,
      CO(3) => \clockdiv0_carry__3_n_0\,
      CO(2) => \clockdiv0_carry__3_n_1\,
      CO(1) => \clockdiv0_carry__3_n_2\,
      CO(0) => \clockdiv0_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(20 downto 17),
      S(3 downto 0) => clockdiv(20 downto 17)
    );
\clockdiv0_carry__4\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__3_n_0\,
      CO(3) => \clockdiv0_carry__4_n_0\,
      CO(2) => \clockdiv0_carry__4_n_1\,
      CO(1) => \clockdiv0_carry__4_n_2\,
      CO(0) => \clockdiv0_carry__4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(24 downto 21),
      S(3 downto 0) => clockdiv(24 downto 21)
    );
\clockdiv0_carry__5\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__4_n_0\,
      CO(3) => \clockdiv0_carry__5_n_0\,
      CO(2) => \clockdiv0_carry__5_n_1\,
      CO(1) => \clockdiv0_carry__5_n_2\,
      CO(0) => \clockdiv0_carry__5_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(28 downto 25),
      S(3 downto 0) => clockdiv(28 downto 25)
    );
\clockdiv0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      CI => \clockdiv0_carry__5_n_0\,
      CO(3) => \NLW_clockdiv0_carry__6_CO_UNCONNECTED\(3),
      CO(2) => \clockdiv0_carry__6_n_1\,
      CO(1) => \clockdiv0_carry__6_n_2\,
      CO(0) => \clockdiv0_carry__6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => data0(32 downto 29),
      S(3 downto 0) => clockdiv(32 downto 29)
    );
...
\clockdiv[32]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\clockdiv_reg[32]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of system_RGBTest_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of Clock : signal is "XIL_INTERFACENAME Clock, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
begin
