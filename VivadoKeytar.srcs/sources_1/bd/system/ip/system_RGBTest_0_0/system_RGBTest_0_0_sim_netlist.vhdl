...
architecture STRUCTURE of system_RGBTest_0_0_RGBTest is
  ...
  signal \NLW_clockdiv0_carry__6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_clockdiv0_carry__6_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
\FSM_onehot_RGB[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_RGB[2]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\clockdiv0_carry__6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_clockdiv0_carry__6_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \clockdiv0_carry__6_n_2\,
      CO(0) => \clockdiv0_carry__6_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_clockdiv0_carry__6_O_UNCONNECTED\(3),
      O(2 downto 0) => data0(31 downto 29),
      S(3) => '0',
      S(2 downto 0) => clockdiv(31 downto 29)
    );
\clockdiv[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00FE"
    )
        port map (
