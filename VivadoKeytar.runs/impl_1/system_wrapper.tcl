...
namespace eval ::optrace {
  variable script "/NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir /NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.cache/wt [current_project]
  set_property parent.project_path /NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.xpr [current_project]
  set_property ip_output_repo /NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet /NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files /NetDrive/Personal/Projects/Keytar/VivadoKeytar/VivadoKeytar.srcs/sources_1/bd/system/system.bd
